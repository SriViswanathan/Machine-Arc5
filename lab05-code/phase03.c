/*
 * phase03.c: Mock phase03 from the "puzzlebox" program in Project 2. It is
 * initialized with a fixed hash value (your project code will have a unique
 * value determined by your x500).
 *
 * Use GDB and knowledge of how bit-wise operations like shifts, ors, and xors
 * work to gain insight into how this works. You'll see a similar problem as
 * part of Project 2!
 */
